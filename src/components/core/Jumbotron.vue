        ...
        <v-slide-x-transition appear>
          <v-col>
            ...
            <v-responsive
              max-width="600"
              class="mb-5"
            >Vivamus elementum semper nisi. Maecenas malesuada. Donec sodales sagittis magna. Proin faucibus arcu quis ante. Vivamus quis mi.</v-responsive>

            <v-btn large class="px-5" color="primary">Hire Me</v-btn>
          </v-col>
  ...
  >
    <v-container fill-height>
      <v-row align-content="center" justify="center" class="fill-height">
        ...
        <v-breadcrumbs :items="breadcrumbs" class="grey--text pb-0 px-3" />
      </v-row>
    </v-container>
  </v-sheet>
</template>
